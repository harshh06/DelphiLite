...
public class delphiParser extends Parser {
	...
	public static final int
		...
		IDENTIFIER=32, INTEGER_LITERAL=33, STRING_LITERAL=34, COMMENT=35, WS=36;
	public static final int
		...
		RULE_typeSection = 22, RULE_classDeclaration = 23, RULE_classParentList = 24, 
		RULE_interfaceDeclaration = 25, RULE_interfaceBody = 26, RULE_interfaceMethodDeclaration = 27, 
		RULE_classBody = 28, RULE_classVisibilitySection = 29, RULE_visibilityModifier = 30, 
		RULE_classMember = 31, RULE_fieldDeclaration = 32, RULE_methodDeclaration = 33, 
		RULE_constructorDeclaration = 34, RULE_destructorDeclaration = 35, RULE_procedureDeclaration = 36, 
		RULE_functionDeclaration = 37, RULE_formalParameterList = 38, RULE_formalParameter = 39;
	...
	public final TypeNameContext typeName() throws RecognitionException {
		...
		try {
			...
			setState(177);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 4294981632L) != 0)) ) {
	...
	public final StatementListContext statementList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4296081416L) != 0)) {
				{
				{
				setState(183);
				statement();
	...
	public final ArgumentListContext argumentList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 30064902144L) != 0)) {
				{
				setState(256);
				expression(0);
				setState(261);
	...
	public final ClassParentListContext classParentList() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_classParentList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ClassVisibilitySectionContext classVisibilitySection() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_classVisibilitySection);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 4294967728L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VisibilityModifierContext visibilityModifier() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_visibilityModifier);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final DestructorDeclarationContext destructorDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_destructorDeclaration);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(349);
