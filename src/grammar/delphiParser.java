...
public class delphiParser extends Parser {
	...
	public static final int
		...
		RULE_breakStatement = 18, RULE_continueStatement = 19, RULE_readlnStatement = 20, 
		RULE_methodCallStatement = 21, RULE_assignmentStatement = 22, RULE_writelnStatement = 23, 
		RULE_expression = 24, RULE_atom = 25, RULE_argumentList = 26, RULE_typeSection = 27, 
		RULE_classDeclaration = 28, RULE_classParentList = 29, RULE_interfaceDeclaration = 30, 
		RULE_interfaceBody = 31, RULE_interfaceMethodDeclaration = 32, RULE_classBody = 33, 
		RULE_classVisibilitySection = 34, RULE_visibilityModifier = 35, RULE_classMember = 36, 
		RULE_fieldDeclaration = 37, RULE_methodDeclaration = 38, RULE_constructorDeclaration = 39, 
		RULE_destructorDeclaration = 40, RULE_procedureDeclaration = 41, RULE_functionDeclaration = 42, 
		RULE_formalParameterList = 43, RULE_formalParameter = 44;
	...
	public final ReadlnStatementContext readlnStatement() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_readlnStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(240);
	...
	public final MethodCallStatementContext methodCallStatement() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_methodCallStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ArgumentListContext argumentList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 31577982808096768L) != 0)) {
				{
				setState(312);
				expression(0);
				setState(317);
	...
	public final TypeSectionContext typeSection() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_typeSection);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ClassParentListContext classParentList() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_classParentList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ClassVisibilitySectionContext classVisibilitySection() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_classVisibilitySection);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 4503599627370928L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VisibilityModifierContext visibilityModifier() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_visibilityModifier);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final DestructorDeclarationContext destructorDeclaration() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_destructorDeclaration);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(405);
